...
import { colorOutput, Value, rwRecord, rwType } from "./T2G_utils";
...
export const rwSyndicList : rwRecord[] = [
    ...
    { rwType: rwType.READ, contract: "T2G_SyndicFacet", function: "getWalletRights", args: [ Value.Account ], label: "Wallet Rights ? ", outcome: [ "number"] },    
    { rwType: rwType.WRITE, contract: "T2G_SyndicFacet", function: "grantWalletRights", args: [ Value.Account, Value.Enum ], label: "Grant new Rights", outcome: [] },
    { rwType: rwType.WRITE, contract: "T2G_SyndicFacet", function: "declineWalletRights", args: [ Value.Account, Value.Enum ], label: "Decline Rights", outcome: [] },
    { rwType: rwType.WRITE, contract: "T2G_SyndicFacet", function: "registerWallet", args: [ Value.Account, Value.Enum ], label: "Register new Wallet", outcome: [] },
