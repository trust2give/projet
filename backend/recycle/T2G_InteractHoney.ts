...
/*export const rwHoneyList : rwRecord[] = [
  ...
  { rwType: rwType.READ, contract: "T2G_HoneyFacet", function: "honey", args: [ Value.TokenId ], label: "HONEY", outcome: [ "Typeoftoken", "Statusoftoken", "bigint", "bigint", "TypeOfUnit", "number"] },
  ...
  { rwType: rwType.WRITE, contract: "T2G_HoneyFacet", function: "addHoneyTxHash", args: [ Value.TokenId, Value.Index, Value.Text ], label: "Add TX Hash", outcome: [] },
